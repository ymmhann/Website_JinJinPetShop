            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-last order-lg-first">
                    <div class="about-text-wrap">
                        <h2><span>Cung cấp sản phẩm</span>Tốt nhất cho thú cưng</h2>
                        <p>Chúng tôi cung cấp các sản phẩm thức ăn và phụ kiện chất lượng tốt nhất dành cho thú cưng của bạn. JinJin tự hào là thương hiệu uy tín đồng hành cùng sức khỏe và sự phát triển của các bé cưng. Bạn có thể hoàn toàn yên tâm lựa chọn sản phẩm của chúng tôi vì sự tận tâm và cam kết chất lượng hàng đầu.</p>
                        <p>Khách hàng luôn tin tưởng và đánh giá cao dịch vụ cũng như sản phẩm chăm sóc thú cưng của JinJin.</p>
                        <p>Chúng tôi cam kết mang lại trải nghiệm mua sắm tuyệt vời nhất, mang đến niềm vui và sự hài lòng cho cả bạn và thú cưng của mình.</p>
                    </div>
                </div>
                <!-- About Text End -->
                <!-- About Image Start -->
